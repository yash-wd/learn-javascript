/* =============================================================================
 * SOLUTIONS · 39 · SECURITY ESSENTIALS — don't get hacked
 * =============================================================================
 * Run:  node lessons/solutions/39-solutions.js
 *
 * Worked answers to the PRACTICE block in lessons/39-security.js.
...
function validateSignup({ email, password }) {
  const errors = [];
  if (!email.includes('@')) errors.push('email looks invalid');
